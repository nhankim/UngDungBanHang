...
public class AdapterSanPhamMoi extends ArrayAdapter<SanPham> {

    Activity context;
    int resource;
    List<SanPham> objects;

    public AdapterSanPhamMoi(@NonNull Activity context, int resource, @NonNull List<SanPham> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView imgItemSanpham = item.findViewById(R.id.imgSanPhamMoi);
        TextView txtItemTensanpham = item.findViewById(R.id.txtTenSanPhamMoi);
        TextView txtItemGiasanpham = item.findViewById(R.id.txtGiaSanPhamMoi);
